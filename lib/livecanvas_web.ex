defmodule LivecanvasWeb do
  ...
  def static_paths,
    do: ~w(assets fonts images favicon.ico robots.txt flexoki-dark.json flexoki-light.json)
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: LivecanvasWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {LivecanvasWeb.Layouts, :app}
